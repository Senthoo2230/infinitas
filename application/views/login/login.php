            ...
            <div class="card-group d-block d-md-flex row">
              <div class="card col-md-7 p-4 mb-0">
                <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-6">
                      <button style="background-color:#ffb700;" class="btn btn-primary px-4" type="submit">Login</button>
                    </div>
              ...
              <div class="card col-md-5 text-white py-5" style="background-color:#ffb700;">
